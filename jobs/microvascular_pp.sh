...
#SBATCH -o logs/microvascular_pp/log.stdout_%a ## STDOUT
#SBATCH -e logs/microvascular_pp/log.stderr_%a ## STDERR
...
Rscript scripts/analysis/microvascular_tte_pp.R $SLURM_ARRAY_TASK_ID